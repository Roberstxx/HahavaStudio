...
export const services = [
  makeService({
    ...
    category: 'unas',
    description: 'Aplicacion de color en gel de larga duracion sobre unas previamente preparadas. Ideal para quienes ya cuentan con manicure o pedicure realizado.',
    priceFrom: 200,
    duration: 45,
    tags: ['unas', 'rapido'],
  ...
  makeService({
    ...
    name: 'Rubber Base',
    category: 'unas',
    description: 'Base flexible que ayuda a fortalecer y proteger la una natural, ideal para unas debiles o quebradizas.',
    priceFrom: 350,
  ...
  makeService({
    ...
    name: 'Builder Gel',
    category: 'unas',
    description: 'Gel constructor que aporta mayor resistencia y permite corregir pequenas imperfecciones de la una natural.',
    priceFrom: 450,
  ...
  makeService({
    ...
    name: 'Polygel',
    category: 'unas',
    description: 'Sistema hibrido ligero y resistente para extensiones o reforzamiento de unas.',
    priceFrom: 550,
  ...
  makeService({
    ...
    name: 'Soft Gel',
    category: 'unas',
    description: 'Extensiones con tips de gel de apariencia natural, ligeras y comodas.',
    priceFrom: 500,
  ...
  makeService({
    ...
    category: 'unas',
    description: 'Set de unas reutilizables disenadas especialmente para cada clienta.',
    priceFrom: 400,
  ...
  makeService({
    ...
    category: 'unas',
    description: 'Alargamiento de unas mediante tip o molde escultural segun la necesidad de la clienta.',
    priceFrom: 600,
    priceLabel: 'Desde $600',
    duration: 120,
    tags: ['unas', 'extensiones'],
  ...
  makeService({
    ...
    category: 'unas',
    description: 'Correccion de unas fracturadas o danadas.',
    priceFrom: 50,
  ...
  makeService({
    ...
    category: 'unas',
    description: 'Servicio especializado para personas que se muerden las unas.',
    priceFrom: null,
  ...
  makeService({
    ...
    category: 'manicure',
    description: 'Limpieza basica de unas y cuticula, limado y acabado natural. No incluye gel semipermanente.',
    priceFrom: 180,
    duration: 45,
  ...
  makeService({
    ...
    category: 'maquillaje',
    description: 'Maquillaje para XV anos con acabado personalizado segun estilo y evento.',
    priceFrom: 1500,
  ...
  makeService({
    ...
    name: 'Corte Dama',
    category: 'cabello',
    description: 'Corte de dama personalizado segun rostro, estilo y necesidades del cabello.',
    priceFrom: 250,
  ...
  makeService({
    ...
    name: 'Ondulado',
    category: 'cabello',
    description: 'Ondas definidas o suaves segun el estilo deseado.',
    priceFrom: 250,
    priceLabel: 'Desde $250',
    duration: 50,
    tags: ['cabello'],
